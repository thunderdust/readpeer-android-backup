...
import socialatwork.readpeer.ProfileActivity;
...
public class ProfileFollowingFragment extends Fragment {
	...
	private final String TAG = "profile following fragment";;
	...
	private Handler handler = new Handler() {
		...
		public void handleMessage(Message m) {
			...
			if (m.what == PICTURE_DOWNLOAD_COMPLETED_MESSAGE) {
				...
				// downloadFollowerImages();
				mAdapter = new ProfileFollowingAdapter(getActivity(),
						mFollowingInfoList);
	...
	public View onCreateView(LayoutInflater inflater, ViewGroup container,
		...
		if (rootView != null) {
			mfollowingListView = (ListView) rootView
		...
		public View getView(final int position, View convertView,
			...
			convertView.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View arg0) {
					Intent toNewProfile = new Intent(getActivity(),
					...
					getActivity().startActivity(toNewProfile);
				}

			});

			String url = urlArray[position % urlArray.length];
			viewHolder.mImageView.setImageResource(R.drawable.default_user_image);
