...
public class ProfileBookActivity extends FragmentActivity {

	private final String TAG = "profile book activity";;
	...
	private Handler bookInfoHandler = new Handler() {
		...
		public void handleMessage(Message m) {
			...
			if (m.what == PICTURE_DOWNLOAD_COMPLETED_MESSAGE) {
				...
				mAdapter = new ProfileBookAdapter(mContext, mBookInfoList);
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mBookListView = (ListView) findViewById(R.id.listview_profile_book);
		getBookInfoJSON();
		loadLocalBookIndex();
	}
