...
public class ProfileFollowerActivity extends FragmentActivity {

	private final String TAG = "profile follower activity";;
	...
	private Handler handler = new Handler() {
		...
		public void handleMessage(Message m) {
			...
			if (m.what == PICTURE_DOWNLOAD_COMPLETED_MESSAGE) {
				...
				// downloadFollowerImages();
				if (mFollowerInfoList!=null){
					Log.d(TAG, "follower info list not null");
				}
				else {
					Log.e(TAG, "INFO LIST NULL");
				}
				mAdapter = new ProfileFollowerAdapter(mContext,
						mFollowerInfoList);
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mfollowerListView = (ListView) findViewById(R.id.listview_profile_follower);
